...
namespace EVMManagement.BLL.Services.Interface
{
    public interface IContractService
    {
        ...
        Task<PagedResult<ContractDetailResponse>> GetAllAsync(Guid? orderId, Guid? customerId, Guid? createdByUserId, ContractStatus? status, int pageNumber = 1, int pageSize = 10);
